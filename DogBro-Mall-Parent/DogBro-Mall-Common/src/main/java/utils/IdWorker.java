...
public class IdWorker {
    ...
    public IdWorker(){
        ...
        this.workerId = getMAX_WORKER_ID(datacenterId, MAX_WORKER_ID);
    }
    /**
     * @param workerId
     *            工作机器ID
     ...
     * </p>
     */
    protected static long getMAX_WORKER_ID(long datacenterId, long MAX_WORKER_ID) {
     ...
     * </p>
     */
    protected static long getDatacenterId(long MAX_DATACENTER_ID) {
        long id = 0L;
        try {
